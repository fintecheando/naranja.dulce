...
public abstract class BaseDiner  implements Comparable, Serializable {

	public static String REF = "Diner";
	public static String PROP_LAST_CLOCK_IN_TIME = "lastClockInTime";
	public static String PROP_TYPE = "type";
	public static String PROP_PASSWORD = "password";
	public static String PROP_USER_ID = "dinerId";
	 ...
	 */
	public BaseDiner (java.lang.Integer autoId) {
	...
	// fields
		protected java.lang.Integer dinerId;
	...
	private com.floreantpos.model.DinerType type;
	 ...
	 */
	public java.lang.Integer getDinerId () {
					return dinerId == null ? Integer.valueOf(0) : dinerId;
			}

	/**
	 * Set the value related to the column: USER_ID
	 * @param dinerId the USER_ID value
	 */
	public void setDinerId (java.lang.Integer dinerId) {
	 ...
	 */
	public com.floreantpos.model.DinerType getType () {
					return type;
			}
	 ...
	 */
	public void setType (com.floreantpos.model.DinerType type) {
		this.type = type;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.floreantpos.model.Diner)) return false;
		else {
			com.floreantpos.model.Diner diner = (com.floreantpos.model.Diner) obj;
			if (null == this.getAutoId() || null == diner.getAutoId()) return false;
			else return (this.getAutoId().equals(diner.getAutoId()));
		}
	}
