...
public abstract class BaseDinerType  implements Comparable, Serializable {

	public static String REF = "DinerType";
	public static String PROP_NAME = "name";
	public static String PROP_ID = "id";


	// constructors
	public BaseDinerType () {
		initialize();
	}
	 ...
	 */
	public BaseDinerType (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.floreantpos.model.DinerType)) return false;
		else {
			com.floreantpos.model.DinerType dinerType = (com.floreantpos.model.DinerType) obj;
			if (0 == this.getId() || 0 == dinerType.getId()) return false;
			else return (this.getId().equals(dinerType.getId()));
		}
	}
