 ...
 */
public abstract class BaseDinerDAO extends com.floreantpos.model.dao._RootDAO {

	// query name references


	public static DinerDAO instance;

	/**
	 * Return a singleton of the DAO
	 */
	public static DinerDAO getInstance () {
		if (null == instance) instance = new DinerDAO();
		return instance;
	}
