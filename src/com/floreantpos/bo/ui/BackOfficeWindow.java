...
import com.floreantpos.bo.actions.DinerExplorerAction;
import com.floreantpos.bo.actions.DinerTypeExplorerAction;
...
public class BackOfficeWindow extends javax.swing.JFrame {
	...
	private void createAdminMenu(JMenuBar menuBar) {
		...
		adminMenu.add(new UserTypeExplorerAction());
                //Se agrega el menu para la administracion de comensales
                adminMenu.add(new DinerExplorerAction());
		adminMenu.add(new DinerTypeExplorerAction());
