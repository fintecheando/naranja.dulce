...
public class DinerTypeExplorerAction extends AbstractAction {

	public DinerTypeExplorerAction() {
		super(com.floreantpos.POSConstants.USER_TYPES);
	}

	public DinerTypeExplorerAction(String name) {
		super(name);
	}

	public DinerTypeExplorerAction(String name, Icon icon) {
		super(name, icon);
	}
